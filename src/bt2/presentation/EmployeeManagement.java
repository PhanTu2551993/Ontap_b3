...
import bt2.business.IEmployee;
import bt2.businessImp.Employee;
...
//    public String findEmployeeByID (Scanner scanner,Employee[] employees){
//        System.out.println("Mời bạn nập ID nhân vieen");
//        String findID = scanner.nextLine();
//        for (int i = 0; i < numEmployees; i++) {
//            if (employees[i].getId().equals(findID)){
//                    return findID;
//            }
//        }
//        return null;
